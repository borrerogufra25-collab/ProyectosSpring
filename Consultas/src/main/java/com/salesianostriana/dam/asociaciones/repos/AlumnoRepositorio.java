...
public interface AlumnoRepositorio extends JpaRepository<Alumno, Long> {
	...
	List<Alumno> findByApellidosContainsIgnoreCaseOrNombreContainsIgnoreCaseOrEmailContainsIgnoreCaseOrderByApellidosDesc(
			String apellidos, String nombre, String email);
	...
	@Query("""
			...
			where a.apellidos = :ape
				or a.nombre = :nom
			""")
	List<Alumno> buscarPorTodov3(@Param("ape") String apellidos, @Param("nom") String nombre);
